...
本模块由后盾网向军老师制作，但是最近一直未更新，本人仅仅是在向军老师的模块的基础上做了依赖包版本的升级，版权仍属于向军老师，有任何问题，请联系本人QQ：328176843

优化内容：  
1. 更新依赖的nwidart/laravel-modules版本为5.0+，解决fire方法的错误；

2. 更新依赖的spatie/laravel-permission版本为3.0+；
